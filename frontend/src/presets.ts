...
export interface ComposeSectionPlan {
  ...
  weight: number
  prompt: string
  gain: number // section level in dB - the energy arc (0 = loudest)
  vocal?: boolean // hook/vocal sections get the user's lyrics
}

export const COMPOSE_PLANS: Record<string, ComposeSectionPlan[]> = {
  House: [
    { name: 'Intro', gain: -6, weight: 0.1, prompt: 'stripped intro, dry drums and shaker only, filtered pads, low energy, no lead' },
    { name: 'Groove', gain: -3, weight: 0.12, prompt: 'bassline enters, percussion locks in, subtle melodic hints, mid energy' },
    { name: 'Build', gain: -2, weight: 0.08, prompt: 'rising tension, layers stacking, filter sweep up, snare roll, riser' },
    { name: 'Drop', gain: 0, weight: 0.2, prompt: 'full drop, main hook front and center, maximum energy, everything moving', vocal: true },
    { name: 'Breakdown', gain: -5, weight: 0.12, prompt: 'drums drop out, atmospheric pads and one melodic element in reverb, emotional pause' },
    { name: 'Build 2', gain: -1.5, weight: 0.08, prompt: 'percussion returning piece by piece, longest riser, biggest tension' },
    { name: 'Drop 2', gain: 0, weight: 0.2, prompt: 'peak moment, extra percussion layer, ad-lib textures, euphoric maximum energy', vocal: true },
    { name: 'Outro', gain: -6, weight: 0.1, prompt: 'elements exiting one by one, back to dry drums, filter closing, fade' },
  ],
  Techno: [
    { name: 'Intro', gain: -6, weight: 0.12, prompt: 'kick and rumble bass alone, dark warehouse atmosphere, hypnotic, minimal' },
    { name: 'Groove', gain: -3, weight: 0.13, prompt: 'hypnotic stab pattern enters, driving hats, relentless momentum' },
    { name: 'Build', gain: -2, weight: 0.08, prompt: 'acid line rising, white noise sweep, tension stacking' },
    { name: 'Peak', gain: 0, weight: 0.2, prompt: 'full power, lead synth hook cutting through, maximum drive', vocal: true },
    { name: 'Breakdown', gain: -5, weight: 0.12, prompt: 'kick disappears, vast dark pad, echoing lead, suspense' },
    { name: 'Build 2', gain: -1.5, weight: 0.08, prompt: 'kick returns with long riser, doubled snares, extreme tension' },
    { name: 'Peak 2', gain: 0, weight: 0.17, prompt: 'hardest section, all layers together, relentless drive', vocal: true },
    { name: 'Outro', gain: -6, weight: 0.1, prompt: 'layers stripping away, kick and rumble fading into darkness' },
  ],
  Trance: [
    { name: 'Intro', gain: -6, weight: 0.1, prompt: 'rolling bassline and crisp percussion, arps hinting the melody' },
    { name: 'Groove', gain: -3, weight: 0.12, prompt: 'plucked sequence enters, energy building steadily' },
    { name: 'Build', gain: -2, weight: 0.08, prompt: 'layers rising, accelerating snare roll, huge riser' },
    { name: 'Drop', gain: 0, weight: 0.2, prompt: 'euphoric main melody full power, wide supersaws, anthem energy', vocal: true },
    { name: 'Breakdown', gain: -5, weight: 0.14, prompt: 'beat stops, emotional piano and pads carry the melody alone' },
    { name: 'Build 2', gain: -1.5, weight: 0.08, prompt: 'melody rejoined by rising drums, longest riser' },
    { name: 'Drop 2', gain: 0, weight: 0.18, prompt: 'biggest euphoric peak, full stack, hands in the air', vocal: true },
    { name: 'Outro', gain: -6, weight: 0.1, prompt: 'melody fading, bassline and percussion closing' },
  ],
  Bass: [
    { name: 'Intro', gain: -6, weight: 0.12, prompt: 'atmospheric textures, sparse drums, dark tension' },
    { name: 'Build', gain: -2, weight: 0.1, prompt: 'accelerating drums, screaming riser, vocal chop echoes, snare roll' },
    { name: 'Drop', gain: 0, weight: 0.22, prompt: 'massive bass hook, heavy and aggressive, maximum impact', vocal: true },
    { name: 'Switch', gain: -1, weight: 0.12, prompt: 'bass pattern flips to new variation, fresh energy' },
    { name: 'Breakdown', gain: -5, weight: 0.12, prompt: 'half-time moment, airy pads, tension reset' },
    { name: 'Build 2', gain: -1.5, weight: 0.08, prompt: 'faster risers, stacking drum fills' },
    { name: 'Drop 2', gain: 0, weight: 0.16, prompt: 'hardest drop, extra bass layers and fills, relentless', vocal: true },
    { name: 'Outro', gain: -6, weight: 0.08, prompt: 'energy decaying, textures dissolving' },
  ],
  Synth: [
    { name: 'Intro', gain: -6, weight: 0.1, prompt: 'iconic synth riff alone with soft drum machine' },
    { name: 'Verse', gain: -3, weight: 0.15, prompt: 'groove settles, pumping bassline, riff developing', vocal: true },
    { name: 'Build', gain: -2, weight: 0.08, prompt: 'drums intensifying, climbing arpeggios, filter opening' },
    { name: 'Chorus', gain: 0, weight: 0.2, prompt: 'full anthem energy, soaring lead melody, wide and bright', vocal: true },
    { name: 'Breakdown', gain: -5, weight: 0.12, prompt: 'stripped to bass and pad, cinematic pause' },
    { name: 'Build 2', gain: -1.5, weight: 0.08, prompt: 'rolling toms, riser, energy returning' },
    { name: 'Chorus 2', gain: 0, weight: 0.17, prompt: 'biggest version, extra harmony layer on the lead', vocal: true },
    { name: 'Outro', gain: -6, weight: 0.1, prompt: 'riff alone, slow fade with reverb tails' },
  ],
  Chill: [
    { name: 'Intro', gain: -6, weight: 0.14, prompt: 'soft textures fading in, gentle rhythm emerging' },
    { name: 'Theme A', gain: -2, weight: 0.18, prompt: 'main melodic motif, warm and intimate, slow groove', vocal: true },
    { name: 'Development', gain: -1.5, weight: 0.18, prompt: 'new layer every phrase, subtle harmonic shifts, warmth rising' },
    { name: 'Peak', gain: 0, weight: 0.18, prompt: 'fullest moment, all layers breathing together, emotional but restrained', vocal: true },
    { name: 'Theme B', gain: -2.5, weight: 0.16, prompt: 'variation of the motif, different color, fresh perspective' },
    { name: 'Outro', gain: -6, weight: 0.16, prompt: 'layers thinning, last melodic echo dissolving into ambience' },
  ],
}
